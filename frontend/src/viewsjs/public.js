...
export function PublicView() {
  ...
  section.innerHTML = `
    <div class="public-hero">
      <img src="https://do-self.vercel.app/favicon.svg" alt="Dö Logo" width="96" height="96" style="margin: 0 auto;">
      ...
      <p class="mt-4 text-gray-500">Already have an account?
        <a data-link href="/login" class="text-indigo-500 underline">Log in</a>
      </p>
    </div>
